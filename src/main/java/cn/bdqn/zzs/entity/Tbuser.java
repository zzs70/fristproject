...
public class Tbuser {
    ...
    public Tbuser(Integer userid, String username, String password, String userroles, String nickname, Date registrationtime, Date systemtime, Date dateofbirth) {
        this.userid = userid;
        this.username = username;
        this.password = password;
